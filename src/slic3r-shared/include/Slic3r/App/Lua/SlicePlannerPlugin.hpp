 ...
 */
constexpr auto SLICE_PLANNER_API_VERSION = "1.0.0";
 ...
 *
 * Layers are offered to the planner one at a time from the bottom up and never concurrently,
 * so unlike the fill, pass and perimeter planners the returned strategy needs no lock.
 */
