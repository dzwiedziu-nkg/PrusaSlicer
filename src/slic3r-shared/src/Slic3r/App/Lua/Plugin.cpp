...
const std::unordered_map<PluginType, std::string> PLUGIN_TYPE_NAMES = {
    ...
    {PluginType::SlicingLayerPlanner, "slicing.layer_planner"},
    {PluginType::SlicingFillPlanner, "slicing.fill_planner"},
    {PluginType::SlicingLoopDirection, "slicing.loop_direction"},
...
const std::unordered_map<PluginType, std::string> PLUGIN_ENTRY_POINTS = {
    ...
    {PluginType::SlicingLayerPlanner, "plan_layer"},
    {PluginType::SlicingFillPlanner, "plan_fill"},
    {PluginType::SlicingLoopDirection, "plan_direction"},
