...
const std::map<PluginApiType, std::string> PLUGIN_API_TYPE_NAMES = {
    ...
    {PluginApiType::SlicingLayerPlanner, "slicing.layer_planner"},
    ...
    {PluginApiType::SlicingSlicePlanner, "slicing.slice_planner"},
    {PluginApiType::SlicingObjectLabels, "slicing.object_labels"}
};
}
